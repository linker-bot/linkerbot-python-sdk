"""Speed control and sensing for L20 robotic hand.

This module provides the SpeedManager class for controlling joint speeds
and reading speed sensor data via CAN bus communication. L20 has 16
...
@dataclass
class L20Speed:
    """Joint speeds for L20 hand (0-100 range).
    ...
    @classmethod
    def from_list(cls, values: list[float]) -> "L20Speed":
...
class SpeedData:
    ...
    Attributes:
        speeds: L20Speed instance containing joint speeds (0-100 range).
...
class SpeedManager:
    ...
    def __init__(self, arbitration_id: int, dispatcher: CANMessageDispatcher) -> None:
        ...
        self._relay = PollingDataRelay[SpeedData](self._pending.clear)

    def set_speeds(self, speeds: L20Speed | list[float]) -> None:
        ...
        Args:
            speeds: L20Speed instance or list of 16 target speeds (range 0-100 each).
        ...
        """
        if not isinstance(speeds, L20Speed):
            speeds = L20Speed.from_list(speeds)
    ...
    def _on_message(self, msg: can.Message) -> None:
        ...
        # All frames received -- merge into L20Speed
