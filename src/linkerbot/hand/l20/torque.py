"""Torque control and sensing for L20 robotic hand.

This module provides the TorqueManager class for controlling joint torques
and reading torque sensor data via CAN bus communication. L20 has 16
...
@dataclass
class L20Torque:
    """Joint torques for L20 hand (0-100 range).
    ...
    @classmethod
    def from_list(cls, values: list[float]) -> "L20Torque":
...
class TorqueData:
    ...
    Attributes:
        torques: L20Torque instance containing joint torques (0-100 range).
...
class TorqueManager:
    ...
    def set_torques(self, torques: L20Torque | list[float]) -> None:
        ...
        Args:
            torques: L20Torque instance or list of 16 target torques (range 0-100 each).
        ...
        """
        if not isinstance(torques, L20Torque):
            torques = L20Torque.from_list(torques)
    ...
    def _on_message(self, msg: can.Message) -> None:
        ...
        # All frames received — merge into L20Torque
