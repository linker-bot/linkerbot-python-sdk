"""Force sensor data acquisition for L20 robotic hand.

This module provides force sensor management for the L20 robotic hand:
...
class ForceSensorManager:
    """Manager for all finger force sensors on the L20 robotic hand.
