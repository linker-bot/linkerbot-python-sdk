"""Temperature sensing for O7 robotic hand.
...
@dataclass
class O7Temperature:
    """Motor temperatures for O7 hand in degrees Celsius (deg C).
    ...
    Attributes:
        ...
        thumb_rotation: Thumb rotation motor temperature in deg C
    """
    ...
    def to_list(self) -> list[float]:
        ...
        Returns:
            List of 7 temperatures in deg C [thumb_flex, thumb_abd, index, middle, ring, pinky, thumb_rotation]
        """
        return [
            self.thumb_flex,
            self.thumb_abd,
    ...
    @classmethod
    def from_list(cls, values: list[float]) -> "O7Temperature":
        """Construct from list of floats in degrees Celsius.

        Args:
            values: List of 7 float values in deg C

        Returns:
            O7Temperature instance
    ...
    @classmethod
    def from_raw(cls, values: list[int]) -> "O7Temperature":
    ...
    def __len__(self) -> int:
        """Return number of temperature sensors (always 7 for O7)."""
        return 7
...
class TemperatureData:
    ...
    Attributes:
        temperatures: O7Temperature instance containing motor temperatures in degrees Celsius (deg C).
        timestamp: Unix timestamp when the data was received.
    """

    temperatures: O7Temperature
    timestamp: float
...
class TemperatureManager:
    ...
    def _on_message(self, msg: can.Message) -> None:
        ...
        temperatures = O7Temperature.from_raw(raw_temperatures)
