"""Force sensor data acquisition for O7 robotic hand.

This module provides force sensor management for the O7 robotic hand:
...
class SingleForceSensorManager:
    ...
    def __init__(
        ...
        self._request_cmd = [command_prefix, 0xC6]  # 0xC6 = 12x6 matrix
...
class ForceSensorManager:
    """Manager for all finger force sensors on the O7 robotic hand.
