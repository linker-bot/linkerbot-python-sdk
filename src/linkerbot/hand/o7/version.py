"""Version information and serial number management for O7 robotic hand.
...
class DeviceInfo:
    ...
    Attributes:
        serial_number: Device serial number (e.g., 'LHO7-03-123-L-B-1-A').
...
class SerialNumberFrames:
    ...
    O7 uses byte index as frame identifier (0, 6, 12, 18) instead of
    sequential frame numbers like L6.
    """

    # Expected byte indices for O7 serial number frames
