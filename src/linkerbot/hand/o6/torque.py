...
class TorqueManager:
    ...
    def set_torques(self, torques: O6Torque | list[float]) -> None:
        ...
        Example:
            ...
            >>> # Using O6Torque instance with normalized values (0-100)
            >>> manager.set_torques(O6Torque(thumb_flex=50.0, thumb_abd=50.0,
            ...                              index=50.0, middle=50.0, ring=50.0, pinky=50.0))
            >>> # Using list with normalized values (0-100)
            >>> manager.set_torques([50.0, 50.0, 50.0, 50.0, 50.0, 50.0])
            >>> # Using actual milliamp units
            >>> manager.set_torques(O6Torque.from_milliamps([800.0, 800.0, 1000.0, 1000.0, 1000.0, 1000.0]))
