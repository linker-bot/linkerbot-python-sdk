"""Communication-error history for O30 object ``0x4F``."""
...
class DiagnosticsManager:
    ...
    def get_communication_errors(
        ...
        payload = self._client.read(
            main_index=protocol.O30_MI_COMMUNICATION_ERROR,
            length=protocol.O30_COMMUNICATION_ERROR_BYTE_LENGTH,
            timeout_ms=timeout_ms,
        )
        return O30CommunicationErrors(
