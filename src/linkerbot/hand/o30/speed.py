"""Speed control and sensing for O30."""
...
class SpeedManager:
    ...
    def __init__(self, client: HandProtocolV1) -> None:
        self._client = client
        self._relay = DataRelay[O30SpeedData]()
    ...
    def set_speeds(
        ...
        *,
        ...
        write_vector(
            self._client,
            main_index=protocol.O30_MI_SPEED,
            values=normalized,
    ...
    def get_blocking(self, timeout_ms: float = 100) -> O30SpeedData:
        data = O30SpeedData(
            speeds=read_vector(
                self._client,
                main_index=protocol.O30_MI_SPEED,
    ...
    def get_snapshot(self) -> O30SpeedData | None:
        return self._relay.snapshot()

    def _send_sense_request(self) -> None:
        self.get_blocking(timeout_ms=100)

    def _set_event_sink(self, sink: Callable[[O30SpeedData], None]) -> None:
