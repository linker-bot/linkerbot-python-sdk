"""Tests for L20 VersionManager with hardware."""
...
from linkerbot.hand.l20 import DeviceInfo, Version
...
class TestDeviceInfo:
    ...
    def test_get_device_info_returns_complete(self, l20_hand: L20):
        """get_device_info should return a DeviceInfo with all fields populated."""
        info = l20_hand.version.get_device_info()
    ...
    def test_serial_number_format(self, l20_hand: L20):
    ...
    def test_version_format(self, l20_hand: L20):
    ...
    def test_device_info_has_timestamp(self, l20_hand: L20):
