"""Tests for L20 streaming with real hardware."""
...
pytestmark = [pytest.mark.l20, pytest.mark.streaming]


class TestStreaming:
    """Test L20 streaming functionality against real hardware."""

    def test_stream_receives_events(self, l20_hand: L20):
        """Stream should receive at least one event."""
        events = []
        try:
            l20_hand.start_polling({SensorSource.ANGLE: 0.1})
            queue = l20_hand.stream()
    ...
    def test_stream_event_types_match_sources(self, l20_hand: L20):
    ...
    def test_stream_multiple_event_types(self, l20_hand: L20):
        """When polling ANGLE and TORQUE, both event types should appear."""
        events: list = []
        try:
            l20_hand.start_polling({SensorSource.ANGLE: 0.1, SensorSource.TORQUE: 0.1})
            queue = l20_hand.stream()
    ...
    def test_stream_event_has_valid_data(self, l20_hand: L20):
    ...
    def test_stream_stop_idempotent_and_reopen(self, l20_hand: L20):
        ...
        try:
            ...
            l20_hand.stop_stream()
            l20_hand.stop_stream()  # idempotent

            # Re-open
            queue2 = l20_hand.stream()
    ...
    def test_stop_stream_clean(self, l20_hand: L20):
    ...
    def test_stream_pattern_matching(self, l20_hand: L20):
