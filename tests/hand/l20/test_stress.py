"""Stress tests: binary search for minimum polling interval on L20."""
...
from linkerbot.hand.l20 import AngleEvent, ForceSensorEvent, SensorSource

pytestmark = [pytest.mark.l20, pytest.mark.stress]
...
class TestPollingIntervalStress:
    ...
    def test_angle_interval(self, l20_hand: L20):
    ...
    def test_force_sensor_interval(self, l20_hand: L20):
    ...
    def test_combined_interval(self, l20_hand: L20):
...
class TestInterleavedReadDuringPolling:
    ...
    def test_speed_read_during_polling(self, l20_hand: L20):
