"""Tests for L20 ForceSensorManager with hardware."""
...
class TestForceSensorBlocking:
    ...
    def test_blocking_double_read_and_baseline(self, l20_hand: L20):
        ...
        # First read
        data1 = l20_hand.force_sensor.get_blocking(timeout_ms=2000)
        ...
        # Second read
        data2 = l20_hand.force_sensor.get_blocking(timeout_ms=2000)
    ...
    def test_each_finger_accessible(self, l20_hand: L20):
        """Each finger should be accessible by name via get_finger()."""
        for name in FINGER_NAMES:
            data = l20_hand.force_sensor.get_finger(name).get_blocking(timeout_ms=1000)
    ...
    def test_snapshot_populated_after_read(self, l20_hand: L20):
        ...
        l20_hand.force_sensor.get_blocking(timeout_ms=2000)
    ...
    def test_per_finger_pressure(
        ...
        for name in FINGER_NAMES:
            ...
            def _read_and_print(n: str = name) -> None:
                data = l20_hand.force_sensor.get_finger(n).get_blocking(timeout_ms=2000)
...
class TestForceSensorStreaming:
    ...
    def test_streaming_all_fingers_detected(self, l20_hand: L20):
        ...
        try:
            l20_hand.start_polling({SensorSource.FORCE_SENSOR: 0.05})
